...
for scale in scale_values:
    ...
    for path in faces:
        ...
        print "SCALE " + str(scale) + " " + str(100*(positives_used+negatives_used)/float(NUM_POSITIVES+NUM_NEGATIVES))+"%"
    ...
    print "SCALE " + str(scale) + " HOG RESULT: " + str( float(2 * g_precision * g_recall) / float(g_precision + g_recall))
